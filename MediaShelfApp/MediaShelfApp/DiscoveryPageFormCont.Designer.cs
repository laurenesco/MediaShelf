...
{
    partial class DiscoveryPageFormCont
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("Segoe UI", 19F, FontStyle.Underline, GraphicsUnit.Point);
            ...
            label6.Location = new Point(40, 315);
            label6.Name = "label6";
            ...
            label7.Location = new Point(40, 375);
            label7.Name = "label7";
            ...
            label8.Font = new Font("Segoe UI", 12F, FontStyle.Underline, GraphicsUnit.Point);
            label8.Location = new Point(40, 159);
            label8.Name = "label8";
            label8.Size = new Size(96, 32);
            label8.TabIndex = 7;
            label8.Text = "Wishlist";
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.Font = new Font("Segoe UI", 12F, FontStyle.Underline, GraphicsUnit.Point);
            label9.Location = new Point(40, 220);
            label9.Name = "label9";
            ...
            label10.Font = new Font("Segoe UI", 12F, FontStyle.Underline, GraphicsUnit.Point);
            label10.Location = new Point(40, 283);
            ...
            label11.Font = new Font("Segoe UI", 12F, FontStyle.Underline, GraphicsUnit.Point);
            label11.Location = new Point(40, 343);
            label11.Name = "label11";
            label11.Size = new Size(83, 32);
            label11.TabIndex = 10;
            label11.Text = "List #3";
            // 
            // DiscoveryPageFormCont
            // 
            ...
            Controls.Add(label2);
            Controls.Add(label1);
            Name = "DiscoveryPageFormCont";
            Text = "DiscoveryPageFormCont";
            ResumeLayout(false);
            PerformLayout();
        }
